...
export const TITLE_GENERATOR_SYSTEM_PROMPT =
  "Gere um título curto e descritivo (3 a 6 palavras) para uma conversa com base na mensagem do usuário. Retorne APENAS o título, nada mais. Sem aspas, sem pontuação no final. O título deve ser dentro do contexto das mensagens";
